...
const AcceptedCard = ({ order, onComplete, onShowDetails }) => {
	...
	return (
		<div className='rounded-lg border border-border p-6 bg-main-white relative hover:shadow-md min-h-60'
			...
			{showOptions &&
				<div className='absolute top-0 left-0 w-full h-full bg-black/50 backdrop-blur-sm flex flex-col justify-center items-center gap-6 z-10'
					...
					<Button variant='success' text='DONE' onClick={() => { onComplete(order.id); setShowOptions(false); }} />
