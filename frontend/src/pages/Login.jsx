...
const Login = () => {
    ...
    const handleRedirectToHomepage = () => navigate('/');
                ...
                <div className='flex flex-col justify-between items-center h-2/3 w-full my-auto'>
                    ...
                    <div className='flex flex-col gap-8 w-3/5'>   
                        <div className='flex flex-col gap-4'>
                            ...
                            <input value={email} onChange={(e) => handleSetEmail(e)} className='py-2 px-1 border-b border-b-text/75 focus:outline-none focus:bg-border/50 focus:border-main focus:rounded-sm' placeholder='doughnot@caketrack.com'/>
                        </div>
                        <div className='flex flex-col gap-4'>
                            <Label variant='login' text='PASSWORD' />
                            <input value={password} onChange={(e) => handleSetPassword(e)} className='py-2 px-1 border-b border-b-text/75 focus:outline-none focus:bg-border/50 focus:border-main focus:rounded-sm' placeholder='strawberricrim23243434'/>
                        </div>
                        ...
                        <span className='w-4/5 mx-auto'>
                            <Button text='Login' variant='form' onClick={handleRedirectToHomepage}/>
                        </span>
                    </div>
                </div>
            </div>
