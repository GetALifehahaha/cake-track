...
const Account = () => {
  ...
  return (
    <ImageBackground source={accountTexture} style={{ flex: 1 }} resizeMode='cover'>
      <SafeAreaView className='flex-1' style={{ backgroundColor: 'rgba(255, 255, 255, 0.82)' }}>
        ...
        <View className='h-[160px] bg-primary rounded-b-[20%] p-6 w-full flex-row gap-2 items-center z-0'>
          ...
          <View>
            ...
            <View className='flex-row'>
              ...
              <Text className='font-bold text-xl text-white ml-0.5'>Track</Text>
            </View>
          </View>
        </View>

        {/* 2. THE FLOATING CARD */}
        <View className='-mt-12 self-center w-[80vw] p-6 border border-gray-300 justify-center items-center shadow-md rounded-2xl z-10' style={{ backgroundColor: 'rgba(255, 255, 255, 0.93)' }}>
          {user ?
            <>
