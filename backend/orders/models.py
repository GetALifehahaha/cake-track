...
class Order(models.Model):
    ...
    refund_account_number = models.CharField(max_length=20, blank=True, null=True)
    customer_adjustment_used = models.BooleanField(default=False)
    customer_adjustment_used_at = models.DateTimeField(null=True, blank=True)
