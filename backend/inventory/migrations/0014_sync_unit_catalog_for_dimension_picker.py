...
def sync_unit_catalog_for_dimension_picker(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("inventory", "0013_container_model_and_unit_catalog_update"),
    ]

    operations = [
        migrations.RunPython(sync_unit_catalog_for_dimension_picker, reverse_code=noop_reverse),
    ]
